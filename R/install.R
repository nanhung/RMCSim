...
#' and \code{C:/Users/} (windows). To install \pkg{GNU MCSim} in Windows,
#' be sure to install Rtools first.
...
#' @param mxstep a numeric value to assign the maximum number
#' of (internally defined) steps
...
#'
#' @export
install_mcsim <- function(version = "6.2.0", directory = NULL, mxstep = 5000) {
  ...
  if (.Platform$OS.type == "unix"){
    ...
    system(paste0("gcc -o ./mod/mod ./mod/*.c"))
    if(file.exists("./mod/mod")){
      cat(paste0("Created 'mod'"))
    }
